...
(function (factory) {
    ...
    lang: {
      'en-US': {
        font: {
          ...
          clear: 'Podrazumevani font',
          height: 'Prostor između linija',
          name: 'Font Familija',
          size: 'Veličina fonta'
        },
        image: {
          image: 'Slika',
          insert: 'Umetni sliku',
          resizeFull: 'Originalna veličina',
          resizeHalf: 'Promenite veličinu pola',
          resizeQuarter: 'Promenite veličinu četvrtina',
          floatLeft: 'Lokacija desno',
          floatRight: 'Lokacija levo',
          floatNone: 'Lokacija ništa',
          dragImageHere: 'Primakni sliku ovde',
          selectFromFiles: 'Umetni sa uređaja',
          url: 'Link slike',
          remove: 'Obriši sliku'
        },
        link: {
          ...
          unlink: 'Prekini vezu',
          edit: 'doradi',
          textToDisplay: 'Prikaz teksta',
          url: 'Na koji link treba da vodi ova veza?',
          openInNewWindow: 'Otvori u novom prozoru'
        },
        video: {
          video: 'Video',
          videoLink: 'Link videa',
          insert: 'Umetni video',
          url: 'Video URL?',
          providers: '(YouTube, Vimeo, Vine, Instagram, DailyMotion or Youku)'
        },
        table: {
          table: 'Tabele(Maksimum 10x10)'
        },
        hr: {
          insert: 'Umetni horizontalni lenjir'
        },
        style: {
          style: 'Stil',
          normal: 'Normalno',
       ...
       //   help: 'Help',
        ...
        paragraph: {
          paragraph: 'Paragraf',
          outdent: 'Ne indentično',
          indent: 'Indentično',
          left: 'Leva',
          center: 'Centar',
          right: 'Desna',
          justify: 'Opravdano puna'
        },
        color: {
          recent: 'Nedavne boje',
          more: 'Ostale boje',
          background: 'Boja pozadine',
          foreground: 'Boja fonta',
          transparent: 'Prozirno',
          setTransparent: 'Postavi prozirno',
          reset: 'Resetuj',
          resetToDefault: 'Podrazumevano',//Reset na podrazumevano'
        },
        shortcut: {
          shortcuts: 'Keyboard shortcuts',
          close: 'Close',
          textFormatting: 'Formatiranje keksta',
          action: 'Action',
  ...
  var Renderer = function () {
    ...
    var tplButtonInfo = {
        ...
        save: function (lang) {
            return tplIconButton('fa fa-save icon-save', {
                event: 'save',
                title: lan.save
            });
        },
